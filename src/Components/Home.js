...
import BannerImages from "../images/hero-img.png"
import ImageCompressor from '../images/images-compression.png';
import ImagetoWebp from '../images/imgtowebp.png';
import TextConverter from '../images/text-convert.png';
import Imgotpdf from '../images/JPG_to_PDF_icon.png';
import Imgtogif from '../images/Image-to-GIF.webp';
            ...
            <div class="container">
              <div class="row gy-4">
                ...
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                  <img src={BannerImages} class="img-fluid animated" alt="" />
                </div>
              </div>
            </div>
        </section>
                ...
                <div class="col-md-4">
                    <div class="card border-0 border-bottom border-dark shadow-sm">
                      <div class="card-body text-center p-4 p-xxl-5">
                        <img src={ImageCompressor} alt='images compressor free' className='tool-icon' />
                  ...
                  <div class="col-md-4">
                    <div class="card border-0 border-bottom border-dark shadow-sm">
                      <div class="card-body text-center p-4 p-xxl-5">
                        <img src={ImagetoWebp} className='tool-icon' />
                  ...
                  <div class="col-md-4">
                    <div class="card border-0 border-bottom border-dark shadow-sm">
                      <div class="card-body text-center p-4 p-xxl-5">
                        <img src={TextConverter} className='tool-icon' />
                        ...
                        <Link to="./converttext" class="text-decoration-none link-warning">
                          Learn More
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
                          </svg>
                  ...
                  <div class="col-md-4">
                    <div class="card border-0 border-bottom border-dark shadow-sm">
                      <div class="card-body text-center p-4 p-xxl-5">
                        <img src={Imgotpdf} className='tool-icon' />
                  ...
                  <div class="col-md-4">
                    <div class="card border-0 border-bottom border-dark shadow-sm">
                      <div class="card-body text-center p-4 p-xxl-5">
                      <img src={Imgtogif} className='tool-icon' />
